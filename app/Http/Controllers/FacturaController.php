...
class FacturaController extends Controller
{
    ...
    public function resumenPDF(Request $request)
    {
        ...
        foreach ($facturas as $factura) {
            ...
            $promedioTipoCambio += $factura->tipo_cambio;
        }
        
        $promedioTipoCambio = $facturas->count() > 0 ? $promedioTipoCambio / $facturas->count() : 0;
        ...
        $totales = [
            ...
            'promedio_tipo_cambio' => $promedioTipoCambio,
