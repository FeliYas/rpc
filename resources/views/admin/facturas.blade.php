        ...
        <div class="py-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select id="filtroProveedor"
                            ...
                            @foreach ($proveedores as $proveedor)
                                <option value="{{ $proveedor->denominacion }}">{{ $proveedor->denominacion }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4" id="tipoCambioGroup" style="display:none;">
                                    <label for="tipo_cambio" class="block text-sm font-medium text-gray-700 mb-1">Tipo de
                                        Cambio
                                        (ARS/USD)</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="mb-4">
                                    <label for="gravado" class="block text-sm font-medium text-gray-700 mb-1">Monto
                                        Gravado
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="iva_monto" name="iva_monto" step="0.01"
                                        class="w-full border border-gray-300 px-4 py-2 rounded-md bg-gray-100 text-right"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    <label for="importe_total"
                                        class="block text-sm font-medium text-gray-700 mb-1">Importe Total
                    ...
                    <form id="editFacturaForm" method="POST"
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <!-- Punto de Venta -->
                                <div class="mb-4">
                                    <label for="edit_puntoventa"
                                        class="block text-sm font-medium text-gray-700 mb-1">Punto de
                                        Venta</label>
                                ...
                                <!-- Número de Factura -->
                                <div class="mb-4">
                                    <label for="edit_nrofactura"
                                        class="block text-sm font-medium text-gray-700 mb-1">Número de
                                        Factura</label>
                                ...
                                <div class="mb-4" id="edit_tipoCambioGroup" style="display:none;">
                                    <label for="edit_tipo_cambio"
                                        class="block text-sm font-medium text-gray-700 mb-1">Tipo de
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <!-- Monto Gravado (en ARS o USD) -->
                                <div class="mb-4">
                                    <label for="edit_gravado" class="block text-sm font-medium text-gray-700 mb-1">Monto
                                        Gravado
                                        (USD)</label>
                                ...
                                <!-- Monto de IVA (calculado automáticamente) -->
                                <div class="mb-4">
                                    <label for="edit_iva_monto" class="block text-sm font-medium text-gray-700 mb-1">Monto
                                        IVA
                                        (USD)</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    <label for="edit_subtotal"
                                        class="block text-sm font-medium text-gray-700 mb-1">Subtotal
                                        (USD)</label>
                                ...
                                <div class="mb-4">
                                    <label for="edit_importe_total"
                                        class="block text-sm font-medium text-gray-700 mb-1">Importe
                                        Total (ARS)</label>
            ...
            <div id="deleteFacturaModal" class="hidden fixed inset-0 z-50 flex items-center justify-center px-4">
                ...
                <div class="relative w-full max-w-md z-50 transition-all duration-300 transform scale-95 opacity-0"
                    ...
                    <form id="deleteFacturaForm" method="POST"
                        class="bg-white rounded-lg shadow-lg w-full overflow-hidden">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="bg-white rounded-lg shadow-lg w-full overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="bg-white rounded-lg border border-gray-200">
                                <table class="w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">TOTAL
                                                GENERAL
                                            </td>
                                            <td
                            ...
                            <div class="mt-4 text-sm text-gray-600">
                                ...
                                <p><strong>Fecha de generación:</strong> {{ \Carbon\Carbon::now()->format('d/m/Y H:i:s') }}
                                </p>
                            </div>
                        </div>
            ...
            <script>
                ...
                function closeModal(modalId) {
                    ...
                    // Identificar el contenido correcto según el modal
                    if (modalId === 'createFacturaModal') {
                        modalContent = document.getElementById('facturaModalContent');
                    } else if (modalId === 'editFacturaModal') {
                        modalContent = document.getElementById('editFacturaContent');
                    } else if (modalId === 'deleteFacturaModal') {
                        modalContent = document.getElementById('deleteFacturaContent');
                    } else if (modalId === 'resumenFacturaModal') {
                        modalContent = document.getElementById('resumenFacturaContent');
                    } else {
                        modalContent = modal.querySelector('.transform');
                    }
                ...
                // Función para manejar cambio de moneda en modal de creación
                ...
                function onMonedaChangeEdit() {
                    ...
                    const labelMonedaGravado = document.querySelector('label[for="edit_gravado"]');
                    const labelMonedaIva = document.querySelector('label[for="edit_iva_monto"]');
                    const labelMonedaSubtotal = document.querySelector('label[for="edit_subtotal"]');
                    const labelMonedaTotal = document.querySelector('label[for="edit_importe_total"]');

                    if (moneda === 'USD') {
                        tipoCambioGroup.style.display = '';
                        if (labelMonedaGravado) labelMonedaGravado.innerHTML = 'Monto Gravado <span>(USD)</span>';
                        if (labelMonedaIva) labelMonedaIva.innerHTML = 'Monto IVA <span>(USD)</span>';
                        if (labelMonedaSubtotal) labelMonedaSubtotal.innerHTML = 'Subtotal <span>(USD)</span>';
                        if (labelMonedaTotal) labelMonedaTotal.innerHTML = 'Importe Total <span>(ARS)</span>';
                    } else {
                        tipoCambioGroup.style.display = 'none';
                        if (labelMonedaGravado) labelMonedaGravado.innerHTML = 'Monto Gravado <span>(ARS)</span>';
                        if (labelMonedaIva) labelMonedaIva.innerHTML = 'Monto IVA <span>(ARS)</span>';
                        if (labelMonedaSubtotal) labelMonedaSubtotal.innerHTML = 'Subtotal <span>(ARS)</span>';
                        if (labelMonedaTotal) labelMonedaTotal.innerHTML = 'Importe Total <span>(ARS)</span>';
                    }
                    calcularTotalEdit();
                }

                // Función para calcular el total en modal de creación
                ...
                // Función para mostrar el resumen de facturas (con manejo correcto de monedas)
                function mostrarResumenFacturas() {
                    ...
                    checkedBoxes.forEach(checkbox => {
                        ...
                        if (facturaData && facturaData.detalles && facturaData.detalles.length > 0) {
                            ...
                            // Para el resumen total: convertir todo a ARS
                            let gravadoARS = 0;
                            let ivaARS = 0;

                            if (moneda === 'USD') {
                                // Si es USD, convertir a ARS usando el tipo de cambio
                                gravadoARS = parseFloat(detalle.gravado) * tipoCambio;
                                ivaARS = parseFloat(detalle.iva_monto) * tipoCambio;
                            } else {
                                // Si es ARS, usar directamente
                            ...
                            totalIvaARS += ivaARS;
                            totalGeneralARS += parseFloat(facturaData.importe_total);
                    ...
                    // Mostrar detalles individuales en la moneda original
                    ...
                    <div>
                        ...
                        <span class="text-gray-600">${factura.proveedor}</span>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    // Configurar eventos para los campos de cálculo en modal de creación
                    ...
                    // Configurar eventos para los campos de cálculo en modal de edición
                    document.getElementById('edit_gravado').addEventListener('input', calcularTotalEdit);
                    document.getElementById('edit_iva_porcentaje').addEventListener('change', calcularTotalEdit);
                    document.getElementById('edit_moneda').addEventListener('change', onMonedaChangeEdit);
                    document.getElementById('edit_tipo_cambio').addEventListener('input', calcularTotalEdit);

                    // Inicializar estado de moneda por defecto
                    onMonedaChange();
                });
            </script>
        @endsection
