...
@section('content')
    <div class="group relative h-full">
        ...
        <div class="w-full flex flex-col gap-8 py-4 ">
            <form id='actualizar-nosotros' action="{{ route('nosotros.update', $nosotros->id) }}" method="POST"
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="md:w-1/3 flex flex-col">
                            ...
                            <div
                                ...
                                <img id="imagen-preview" src="{{ asset('storage/' . $nosotros->path) }}" alt="Imagen"
                        ...
                        <div class="flex flex-col justify-between w-full md:w-2/3">
                            <div class="flex flex-col gap-4">
                                <div class="relative group">
                                    ...
                                    <input type="text" id="titulo" name="titulo" value="{{ $nosotros->titulo }}"
                                ...
                                <div class="custom-container">
                                    ...
                                    <textarea name="descripcion" class="summernotep w-full" data-placeholder="Descripción en español...">{{ $nosotros->descripcion }}</textarea>
                                </div>
                            </div>
            ...
            <div class="flex gap-8">
                <x-tarjeta-nosotros :imagen="$nosotros->imagen1" :titulo="$nosotros->titulo1" :descripcion="$nosotros->descripcion1" editRoute="tarjetanos.update"
                    :id="$nosotros->id" :num="1" />
                <x-tarjeta-nosotros :imagen="$nosotros->imagen2" :titulo="$nosotros->titulo2" :descripcion="$nosotros->descripcion2" editRoute="tarjetanos.update"
                    :id="$nosotros->id" :num="2" />
                <x-tarjeta-nosotros :imagen="$nosotros->imagen3" :titulo="$nosotros->titulo3" :descripcion="$nosotros->descripcion3" editRoute="tarjetanos.update"
                    :id="$nosotros->id" :num="3" />
            </div>
